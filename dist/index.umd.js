(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/slicedToArray'), require('react')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/slicedToArray', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['datavis-library-tcc'] = factory(global._toConsumableArray, global._slicedToArray, global.React));
}(this, (function (_toConsumableArray, _slicedToArray, React) { 'use strict';
  ...
  var LineChartContext = /*#__PURE__*/React__default['default'].createContext(null);

  var Labels = function Labels() {
    var _useContext = React.useContext(LineChartContext),
    ...
    var labelsRef = React.useRef(null);
    ...
    return /*#__PURE__*/React__default['default'].createElement("g", {
      ...
      }, /*#__PURE__*/React__default['default'].createElement("textPath", {
  ...
  var Marks = function Marks() {
    ...
    for (var index = 0; index <= yAxisSize; index += yAxisSize / 10) {
      marks.push( /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, {
    ...
    return /*#__PURE__*/React__default['default'].createElement("g", null, marks);
  };
  ...
  function BarChart(_ref) {
    ...
    var highestValue = Math.max.apply(Math, _toConsumableArray__default['default'](data));
    ...
    return /*#__PURE__*/React__default['default'].createElement(LineChartContext.Provider, {
      value: context
      ...
      ref: graphRef
    }, /*#__PURE__*/React__default['default'].createElement(Rulers, null), /*#__PURE__*/React__default['default'].createElement(Labels, null), /*#__PURE__*/React__default['default'].createElement(Bars, null)));
  }
